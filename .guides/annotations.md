...
#SOME STANDARD JAVASCRIPT FUNCTIONS
...
#Math Functions
>Select 'Math' from the ![](.guides/an-img/rocket.png) Rocket menu at the top to load some code or restore it if you mess it up.
...
#String Functions
>Select 'Strings' from the ![](.guides/an-img/rocket.png) Rocket menu at the top to load some code or restore it if you mess it up.
...
@annotation:tour datefuncs
#Date Functions
>Select 'Dates' from the ![](.guides/an-img/rocket.png) Rocket menu at the top to load some code or restore it if you mess it up.
...
@annotation:tour arrayfuncs
#Array Functions
>Select 'Arrays' from the ![](.guides/an-img/rocket.png) Rocket menu at the top to load some code or restore it if you mess it up.
...
@annotation:tour other
#The Wonderful World of APIs
>Select 'APIs' from the ![](.guides/an-img/rocket.png) Rocket menu at the top to load some code or restore it if you mess it up.
...
@annotation:tour otherexp
#Sample Code Explained
Assuming you have loaded the 'APIs' code from the ![](.guides/an-img/rocket.png) Rocket menu at the top, we'll now explain some of the simple API functions we show there.
